...
public class LineMoveToFixedPtAction extends PickTwoFixedPointsOnMesh{
     ...
     */
    public static final String LINE_MOVE_ACTION_NAME = "lineMoveToFixedPtAction";
    
    /**
     * Name of the action for hitting the mouse to signify either a start
     *      or end point for the path
     */
    public static final String POINT_CLICK_FOR_LINE_MOVE_ACTION_NAME = "pickFixedPtPointForLineMove";
    
    /**
     * The keyboard key to trigger the line move action
     */
    public static final int LINE_MOVE_ACTION_KEY = KeyInput.KEY_K;

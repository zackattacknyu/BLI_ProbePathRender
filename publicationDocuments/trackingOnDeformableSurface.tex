...
\\
Our process started with taking a 3D scan of the surface to get the mesh. After creating and refining the 3D scan, we loaded it into a video game style environment that allowed us to produce live updates. \\
\\
